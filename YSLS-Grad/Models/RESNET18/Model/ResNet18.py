...
model_filename = os.path.join(results_folder, 'ResNet18_File_4.pt')
...
results_txt_file2 = os.path.join(results_folder, "ResNet18_File_2.txt")
...
results_txt_file3 = os.path.join(results_folder, "ResNet18_File_3.txt")
